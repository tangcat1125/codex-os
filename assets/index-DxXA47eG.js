(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var app=document.getElementById(`app`),VirtualFS=class{constructor(){this.root=this.load()||{"C:":{type:`dir`,children:{WINDOWS:{type:`dir`,children:{}},"Program Files":{type:`dir`,children:{}},"My Documents":{type:`dir`,children:{}}}},"A:":{type:`dir`,children:{}}}}save(){localStorage.setItem(`win95_vfs`,JSON.stringify(this.root))}load(){try{return JSON.parse(localStorage.getItem(`win95_vfs`))}catch{return null}}get(e){if(!e)return this.root;let t=e.split(`\\`).filter(e=>e),n=this.root;for(let e of t){if(!n[e])return null;n=n[e].type===`dir`?n[e].children:n[e]}return n}write(e,t,n,r=!1){let i=this.get(e);return i?(i[t]={type:`file`,data:n,isImage:r},this.save(),!0):!1}remove(e,t){let n=this.get(e);return n&&n[t]?(delete n[t],this.save(),!0):!1}},vfs=new VirtualFS,currentExplorerPath=``,currentDialogMode=`open`,currentDialogApp=``,currentDialogPath=`C:\\My Documents`,currentSelectedFile=null;window.openExplorer=function(e=``){openWin(`win-explorer`),renderExplorer(e)},window.renderExplorer=function(e){currentExplorerPath=e,document.getElementById(`explorer-path`).innerText=e||`My Computer`;let t=document.getElementById(`explorer-content`);t.innerHTML=``;let n=vfs.get(e);n&&Object.keys(n).forEach(r=>{let i=n[r],a=i.type===`dir`||i.children,o=document.createElement(`div`);o.className=`fs-icon`;let s=a?`https://win98icons.alexmeub.com/icons/png/directory_closed-4.png`:`https://win98icons.alexmeub.com/icons/png/file_lines-0.png`;(r===`C:`||r===`A:`)&&(s=r===`C:`?`https://win98icons.alexmeub.com/icons/png/drive_disk-4.png`:`https://win98icons.alexmeub.com/icons/png/drive_floppy_525-4.png`),i.isImage&&(s=`https://win98icons.alexmeub.com/icons/png/image_document-0.png`),o.innerHTML=`<div class="img" style="background: url('${s}') no-repeat center; background-size: contain;"></div><div class="label">${r}</div>`,o.onclick=()=>{document.querySelectorAll(`#explorer-content .fs-icon`).forEach(e=>e.classList.remove(`selected`)),o.classList.add(`selected`),currentSelectedFile=r},o.ondblclick=()=>{if(a)renderExplorer(e?e+`\\`+r:r);else if(i.isImage){openWin(`win-paint`);let e=new Image;e.onload=()=>{let t=document.getElementById(`paint-canvas`),n=t.getContext(`2d`);n.fillStyle=`white`,n.fillRect(0,0,t.width,t.height),n.drawImage(e,0,0)},e.src=i.data,document.querySelector(`#win-paint .win-titlebar span`).innerText=`Paint - ${r}`}else openWin(`win-notepad`),document.querySelector(`.notepad-area`).value=i.data,document.querySelector(`#win-notepad .win-titlebar span`).innerText=`${r} - Notepad`},t.appendChild(o)})},window.explorerUp=function(){if(!currentExplorerPath)return;let e=currentExplorerPath.split(`\\`);e.pop(),renderExplorer(e.join(`\\`))},window.explorerDelete=function(){currentSelectedFile&&vfs.remove(currentExplorerPath,currentSelectedFile)&&(renderExplorer(currentExplorerPath),currentSelectedFile=null)},window.openDialog=function(e,t){currentDialogApp=e,currentDialogMode=t,openWin(`win-filedialog`),document.getElementById(`dialog-filename`).value=``,document.querySelector(`#win-filedialog .win-titlebar span`).innerText=t===`save`?`Save As`:`Open`,document.getElementById(`dialog-action-btn`).innerText=t===`save`?`Save`:`Open`,renderDialogList(currentDialogPath)},window.renderDialogList=function(e){currentDialogPath=e,document.getElementById(`dialog-path-display`).innerText=e;let t=document.getElementById(`dialog-list`);t.innerHTML=``;let n=vfs.get(e);if(n){if(e){let n=document.createElement(`div`);n.className=`fs-icon`,n.innerHTML=`<div class="img" style="background: url('https://win98icons.alexmeub.com/icons/png/directory_open-4.png') no-repeat center; background-size: contain;"></div><div class="label">[..]</div>`,n.ondblclick=()=>{let t=e.split(`\\`);t.pop(),renderDialogList(t.join(`\\`))},t.appendChild(n)}Object.keys(n).forEach(r=>{let i=n[r],a=i.type===`dir`||i.children,o=document.createElement(`div`);o.className=`fs-icon`;let s=a?`https://win98icons.alexmeub.com/icons/png/directory_closed-4.png`:`https://win98icons.alexmeub.com/icons/png/file_lines-0.png`;(r===`C:`||r===`A:`)&&(s=r===`C:`?`https://win98icons.alexmeub.com/icons/png/drive_disk-4.png`:`https://win98icons.alexmeub.com/icons/png/drive_floppy_525-4.png`),i.isImage&&(s=`https://win98icons.alexmeub.com/icons/png/image_document-0.png`),o.innerHTML=`<div class="img" style="background: url('${s}') no-repeat center; background-size: contain;"></div><div class="label">${r}</div>`,o.onclick=()=>{document.querySelectorAll(`#dialog-list .fs-icon`).forEach(e=>e.classList.remove(`selected`)),o.classList.add(`selected`),a||(document.getElementById(`dialog-filename`).value=r)},o.ondblclick=()=>{a?renderDialogList(e?e+`\\`+r:r):(document.getElementById(`dialog-filename`).value=r,dialogAction())},t.appendChild(o)})}},window.dialogAction=function(){let e=document.getElementById(`dialog-filename`).value;if(!(!e&&currentDialogMode===`save`)){if(currentDialogMode===`save`){if(currentDialogApp===`notepad`){let t=document.querySelector(`.notepad-area`).value;vfs.write(currentDialogPath,e.includes(`.`)?e:e+`.txt`,t,!1),document.querySelector(`#win-notepad .win-titlebar span`).innerText=`${e} - Notepad`}else if(currentDialogApp===`paint`){let t=document.getElementById(`paint-canvas`).toDataURL(`image/png`);vfs.write(currentDialogPath,e.includes(`.`)?e:e+`.bmp`,t,!0),document.querySelector(`#win-paint .win-titlebar span`).innerText=`Paint - ${e}`}}else{let t=vfs.get(currentDialogPath)[e];if(t&&!t.children){if(currentDialogApp===`notepad`&&!t.isImage)document.querySelector(`.notepad-area`).value=t.data,document.querySelector(`#win-notepad .win-titlebar span`).innerText=`${e} - Notepad`;else if(currentDialogApp===`paint`&&t.isImage){let n=new Image;n.onload=()=>{let e=document.getElementById(`paint-canvas`),t=e.getContext(`2d`);t.fillStyle=`white`,t.fillRect(0,0,e.width,e.height),t.drawImage(n,0,0)},n.src=t.data,document.querySelector(`#win-paint .win-titlebar span`).innerText=`Paint - ${e}`}}}closeWin(`win-filedialog`),currentExplorerPath&&renderExplorer(currentExplorerPath)}};var BIOS_SCREEN=`
...
`;app.innerHTML=`
  ...
  ${WIN95_SPLASH}
  ${DESKTOP}
`;var audioCtx,soundEnabled=!1,isConnected=!0;function initAudio(){soundEnabled&&(audioCtx||=new(window.AudioContext||window.webkitAudioContext))}function beep(){if(!soundEnabled||!audioCtx)return;let e=audioCtx.createOscillator(),t=audioCtx.createGain();e.type=`square`,e.frequency.value=1e3,e.connect(t),t.connect(audioCtx.destination),e.start(),t.gain.setValueAtTime(.1,audioCtx.currentTime),setTimeout(()=>e.stop(),200)}function floppySeek(){if(!soundEnabled||!audioCtx)return;let e=.1,t=audioCtx.createOscillator(),n=audioCtx.createGain();t.type=`sawtooth`,t.frequency.setValueAtTime(150+Math.random()*50,audioCtx.currentTime),t.frequency.exponentialRampToValueAtTime(80,audioCtx.currentTime+e),t.connect(n),n.connect(audioCtx.destination),n.gain.setValueAtTime(.2,audioCtx.currentTime),n.gain.exponentialRampToValueAtTime(.01,audioCtx.currentTime+e),t.start(),t.stop(audioCtx.currentTime+e)}function hddSeek(){if(!soundEnabled||!audioCtx)return;let e=audioCtx.sampleRate*.05,t=audioCtx.createBuffer(1,e,audioCtx.sampleRate),n=t.getChannelData(0);for(let t=0;t<e;t++)n[t]=Math.random()*2-1;let r=audioCtx.createBufferSource();r.buffer=t;let i=audioCtx.createBiquadFilter();i.type=`lowpass`,i.frequency.value=800;let a=audioCtx.createGain();a.gain.setValueAtTime(.1,audioCtx.currentTime),a.gain.exponentialRampToValueAtTime(.01,audioCtx.currentTime+.05),r.connect(i),i.connect(a),a.connect(audioCtx.destination),r.start()}function playDTMF(e,t,n){if(!soundEnabled||!audioCtx)return;let r=audioCtx.createOscillator(),i=audioCtx.createOscillator(),a=audioCtx.createGain();r.type=`sine`,i.type=`sine`,r.frequency.value=e,i.frequency.value=t,r.connect(a),i.connect(a),a.connect(audioCtx.destination),a.gain.setValueAtTime(.05,audioCtx.currentTime),r.start(),i.start(),setTimeout(()=>{r.stop(),i.stop()},n)}var dtmfFreqs={1:[697,1209],2:[697,1336],3:[697,1477],4:[770,1209],5:[770,1336],6:[770,1477],7:[852,1209],8:[852,1336],9:[852,1477],"*":[941,1209],0:[941,1336],"#":[941,1477]};async function dialNumber(e){if(!(!soundEnabled||!audioCtx))for(let t of e)dtmfFreqs[t]&&(playDTMF(dtmfFreqs[t][0],dtmfFreqs[t][1],150),await sleep(200))}function playModemHandshake(){return!soundEnabled||!audioCtx?Promise.resolve():new Promise(e=>{let t=8,n=audioCtx.sampleRate*8,r=audioCtx.createBuffer(1,n,audioCtx.sampleRate),i=r.getChannelData(0);for(let e=0;e<n;e++)i[e]=Math.random()*2-1;let a=audioCtx.createBufferSource();a.buffer=r;let o=audioCtx.createBiquadFilter();o.type=`bandpass`,o.frequency.setValueAtTime(2e3,audioCtx.currentTime),o.frequency.linearRampToValueAtTime(4e3,audioCtx.currentTime+3),o.frequency.linearRampToValueAtTime(1e3,audioCtx.currentTime+6),o.frequency.linearRampToValueAtTime(3e3,audioCtx.currentTime+8);let s=audioCtx.createGain();s.gain.setValueAtTime(.05,audioCtx.currentTime),a.connect(o),o.connect(s),s.connect(audioCtx.destination),a.start(),setTimeout(()=>e(),8*1e3)})}var sleep=e=>new Promise(t=>setTimeout(t,e));async function startBoot(){document.getElementById(`power-overlay`).classList.add(`hidden`),initAudio();let e=document.getElementById(`bios-ui`);e.classList.remove(`hidden`);let t=document.getElementById(`mem-count`),n=0;for(hddSeek();n<524288;)n+=16384,t.innerText=n,hddSeek(),await sleep(40);beep(),await sleep(500);let r=document.getElementById(`bios-messages`);r.innerHTML+=`<div>Award Plug and Play BIOS Extension v1.0A</div>`,await sleep(200),r.innerHTML+=`<div>Initialize Plug and Play Cards...</div>`,await sleep(300),r.innerHTML+=`<div>PNP Init Completed</div>`,await sleep(200),r.innerHTML+=`<div>Detecting IDE Primary Master ... WDC AC250MB</div>`;for(let e=0;e<3;e++)hddSeek(),await sleep(100);await sleep(200),r.innerHTML+=`<div>Detecting IDE Primary Slave  ... None</div>`,await sleep(200),document.getElementById(`boot-prompt`).innerText=`Booting from drive A...`,await sleep(500);for(let e=0;e<5;e++)floppySeek(),await sleep(150+Math.random()*100);document.getElementById(`boot-prompt`).innerHTML=`Booting from drive A...<br>Disk I/O error<br>Replace the disk, and then press any key`,await sleep(1e3),document.getElementById(`boot-prompt`).innerHTML=`Booting from drive C...`;for(let e=0;e<3;e++)hddSeek(),await sleep(100);e.classList.add(`hidden`);let i=document.getElementById(`dos-ui`);i.classList.remove(`hidden`);let a=document.getElementById(`dos-content`);a.innerHTML+=`<div>Starting MS-DOS...</div>`,await sleep(500),hddSeek(),a.innerHTML+=`<br><div>HIMEM is testing extended memory...done.</div>`,await sleep(400),hddSeek(),a.innerHTML+=`<div>C:\\>C:\\WINDOWS\\net start</div>`,await sleep(400),a.innerHTML+=`<div>C:\\>win</div>`,hddSeek(),await sleep(400),i.classList.add(`hidden`);let o=document.getElementById(`splash-ui`);o.classList.remove(`hidden`);for(let e=0;e<50;e++)e%3==0&&hddSeek(),await sleep(100);o.classList.add(`hidden`),document.getElementById(`desktop-ui`).classList.remove(`hidden`),[261.63,329.63,392,523.25].forEach((e,t)=>{setTimeout(()=>{let t=audioCtx.createOscillator(),n=audioCtx.createGain();t.type=`sine`,t.frequency.value=e,t.connect(n),n.connect(audioCtx.destination),t.start(),n.gain.setValueAtTime(.1,audioCtx.currentTime),n.gain.exponentialRampToValueAtTime(.01,audioCtx.currentTime+2),setTimeout(()=>t.stop(),2e3)},t*150)})}document.getElementById(`guide-btn`).addEventListener(`click`,()=>{document.getElementById(`prestart-guide`).classList.toggle(`hidden`)});var prestartMessage=document.getElementById(`prestart-message`),setPrestartMessage=e=>{prestartMessage&&(prestartMessage.textContent=e)},soundBtn=document.getElementById(`btn-sound`);soundBtn.addEventListener(`click`,async()=>{if(soundEnabled=!soundEnabled,soundEnabled){initAudio();try{await audioCtx?.resume?.()}catch{}soundBtn.textContent=`Sound: ON`,setPrestartMessage(`音效已啟用。現在請找到正確的 POWER 開關。`)}else soundBtn.textContent=`Sound: OFF`,setPrestartMessage(`音效已關閉。`)}),document.getElementById(`btn-reset`).addEventListener(`click`,()=>{setPrestartMessage(`Reset pressed…（沒有反應）`)}),document.getElementById(`btn-turbo`).addEventListener(`click`,()=>{setPrestartMessage(`Turbo toggled…（看起來更快了但其實沒有）`)}),document.querySelectorAll(`.pc80586-switch[data-switch]`).forEach(e=>{e.addEventListener(`click`,()=>{if(e.getAttribute(`data-switch`)===`sw2`){setPrestartMessage(`通電成功。Power good。`),startBoot();return}setPrestartMessage(`喀噠…沒有反應。再試試看其他開關。`)})}),document.getElementById(`power-switch`).addEventListener(`click`,()=>{setPrestartMessage(`按下 POWER…但沒有通電。（這顆只是面板按鍵）`)}),window.previewBg=function(e){document.getElementById(`bg-preview`).style.backgroundImage=`url(`+e+`)`},window.applyBg=function(){let e=document.getElementById(`bg-select`).value;e&&(document.getElementById(`desktop-ui`).style.backgroundImage=`url(`+e+`)`)},window.toggleStartMenu=function(e){e.stopPropagation(),document.getElementById(`start-menu`).classList.toggle(`hidden`)},window.closeStartMenu=function(){let e=document.getElementById(`start-menu`);e&&!e.classList.contains(`hidden`)&&e.classList.add(`hidden`)};var zIndex=10,taskbarApps=document.getElementById(`taskbar-apps`);function bringToFront(e){let t=document.getElementById(e);if(t){t.style.zIndex=++zIndex,document.querySelectorAll(`.win-titlebar`).forEach(e=>e.classList.add(`inactive`)),t.querySelector(`.win-titlebar`).classList.remove(`inactive`),document.querySelectorAll(`.taskbar-btn`).forEach(e=>e.classList.remove(`active`));let n=document.getElementById(`tbtn-`+e);n&&n.classList.add(`active`)}}window.openWin=function(e){let t=document.getElementById(e);if(t.classList.remove(`hidden`),!document.getElementById(`tbtn-`+e)){let n=t.querySelector(`.win-titlebar span`).innerText,r=document.createElement(`div`);r.id=`tbtn-`+e,r.className=`taskbar-btn`,r.innerText=n,r.onclick=()=>{t.classList.contains(`hidden`)||t.style.display===`none`?(t.style.display=`flex`,t.classList.remove(`hidden`),bringToFront(e)):t.querySelector(`.win-titlebar`).classList.contains(`inactive`)?bringToFront(e):window.minWin(e)},taskbarApps.appendChild(r)}t.style.display=`flex`,bringToFront(e),closeStartMenu(),e===`win-dos`&&setTimeout(()=>document.getElementById(`dos-input`).focus(),100)},window.closeWin=function(e){let t=document.getElementById(e);t.classList.add(`hidden`),t.style.display=`none`;let n=document.getElementById(`tbtn-`+e);n&&n.remove()},window.minWin=function(e){document.getElementById(e).style.display=`none`;let t=document.getElementById(`tbtn-`+e);t&&t.classList.remove(`active`)},window.maxWin=function(e){document.getElementById(e).classList.toggle(`maximized`),bringToFront(e)};var isDragging=!1,dragWin=null,dragOffsetX=0,dragOffsetY=0;document.addEventListener(`mousedown`,e=>{let t=e.target.closest(`.win-titlebar`);if(t&&!e.target.closest(`.win-controls`)){let n=t.closest(`.win95-window`);if(bringToFront(n.id),!n.classList.contains(`maximized`)){isDragging=!0,dragWin=n;let t=n.getBoundingClientRect();dragOffsetX=e.clientX-t.left,dragOffsetY=e.clientY-t.top}}else{let t=e.target.closest(`.win95-window`);t&&bringToFront(t.id)}});var isResizing=!1,resizeWin=null,startW=0,startH=0,startX=0,startY=0;document.addEventListener(`mousedown`,e=>{if(e.target.classList.contains(`win-resizer`)){let t=e.target.closest(`.win95-window`);if(bringToFront(t.id),!t.classList.contains(`maximized`)){isResizing=!0,resizeWin=t,startX=e.clientX,startY=e.clientY;let n=t.getBoundingClientRect();startW=n.width,startH=n.height,e.preventDefault()}}}),document.addEventListener(`mousemove`,e=>{isDragging&&dragWin?(dragWin.style.left=e.clientX-dragOffsetX+`px`,dragWin.style.top=e.clientY-dragOffsetY+`px`):isResizing&&resizeWin&&(resizeWin.style.width=startW+e.clientX-startX+`px`,resizeWin.style.height=startH+e.clientY-startY+`px`)}),document.addEventListener(`mouseup`,()=>{isDragging=!1,dragWin=null,isResizing=!1,resizeWin=null});var calcVal=`0`,calcPrev=null,calcOp=null;window.calcInput=function(key){[`+`,`-`,`*`,`/`].includes(key)?(calcPrev=calcVal,calcOp=key,calcVal=`0`):key===`=`?calcOp&&calcPrev&&(calcVal=String(eval(calcPrev+calcOp+calcVal)),calcOp=null):key===`C`?(calcVal=`0`,calcPrev=null,calcOp=null):calcVal=key===`CE`?`0`:key===`B`?calcVal.length>1?calcVal.slice(0,-1):`0`:key===`+/-`?calcVal.startsWith(`-`)?calcVal.slice(1):`-`+calcVal:calcVal===`0`?key:calcVal+key,document.getElementById(`calc-display`).innerText=calcVal},window.handleDos=function(e){if(e.key===`Enter`){let t=e.target.value.trim(),n=document.getElementById(`dos-history`);n.innerHTML+=`<div>C:\\WINDOWS&gt;`+t+`</div>`,t.toLowerCase()===`exit`?closeWin(`win-dos`):t.toLowerCase()===`dir`?n.innerHTML+=`<div> Volume in drive C is MS-DOS_6<br> Directory of C:\\WINDOWS<br>SYSTEM       &lt;DIR&gt;        05-28-26  8:00a<br>WIN      COM       12,345 05-28-26  8:00a<br></div>`:t&&(n.innerHTML+=`<div>Bad command or file name</div>`),e.target.value=``;let r=document.getElementById(`dos-terminal`);r.scrollTop=r.scrollHeight}};var paintColor=`#000000`;setTimeout(()=>{let e=document.getElementById(`paint-canvas`);if(e){let t=e.getContext(`2d`);t.fillStyle=`white`,t.fillRect(0,0,e.width,e.height);let n=!1;e.onmousedown=e=>{n=!0,t.beginPath(),t.moveTo(e.offsetX,e.offsetY),t.strokeStyle=paintColor,t.lineWidth=2},e.onmousemove=e=>{n&&(t.lineTo(e.offsetX,e.offsetY),t.stroke())},e.onmouseup=()=>n=!1,e.onmouseleave=()=>n=!1;let r=`#000000.#808080.#800000.#808000.#008000.#008080.#000080.#800080.#808040.#004040.#0080ff.#004080.#4000ff.#804000.#ffffff.#c0c0c0.#ff0000.#ffff00.#00ff00.#00ffff.#0000ff.#ff00ff.#ffff80.#00ff80.#80ffff.#8080ff.#ff0080.#ff8040`.split(`.`),i=document.getElementById(`paint-palette-grid`);r.forEach(e=>{let t=document.createElement(`div`);t.className=`paint-color-cell`,t.style.backgroundColor=e,t.onclick=()=>{paintColor=e,document.getElementById(`current-fg-color`).style.backgroundColor=e},i.appendChild(t)})}},1e3),window.openDialUp=function(){openWin(`win-dialup`)},window.startDialUp=async function(){let e=document.getElementById(`dial-status`),t=document.getElementById(`btn-dial`);if(isConnected){e.innerText=`Disconnected.`,t.innerText=`Connect`,isConnected=!1;return}t.disabled=!0,e.innerText=`Dialing 4125000...`,await dialNumber(`4125000`),await sleep(500),e.innerText=`Handshaking with server...`,await playModemHandshake(),e.innerText=`Verifying username and password...`,await sleep(2e3),e.innerText=`Connected at 56,000 bps.`,isConnected=!0,t.innerText=`Disconnect`,t.disabled=!1},window.openIE=function(){openWin(`win-ie`),renderIEPage(document.getElementById(`ie-address`).value)},window.handleIENav=function(e){e.key===`Enter`&&renderIEPage(e.target.value)};function renderIEPage(e){let t=document.getElementById(`ie-content`);if(!isConnected){t.innerHTML=`
    ...
    `;return}e.toLowerCase().includes(`yahoo.com`)?t.innerHTML=`
    ...
    `}setInterval(()=>{let e=document.getElementById(`tray-clock`);if(e){let t=new Date;e.innerText=t.getHours().toString().padStart(2,`0`)+`:`+t.getMinutes().toString().padStart(2,`0`)}},1e3);